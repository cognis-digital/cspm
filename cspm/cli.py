"""CSPM command-line interface."""
from __future__ import annotations
import argparse, sys
from cspm.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="cspm", description="CSPM — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from cspm.mcp_server import serve
        return serve()
    if args.cmd == "scan":
