#!/usr/bin/env sh
# Universal installer for cspm. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/cspm.git"
echo "Installing cspm ..."
